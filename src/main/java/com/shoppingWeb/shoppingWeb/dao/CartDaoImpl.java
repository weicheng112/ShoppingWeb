...
import com.shoppingWeb.shoppingWeb.mapper.CartRowMapper;
import com.shoppingWeb.shoppingWeb.mapper.CartVORowMapper;
...
public class CartDaoImpl implements CartDao{
    ...
    public Integer DeleteByCid(Integer cid) {
        String sql = "DELETE FROM t_cart WHERE cid = :Cid";
